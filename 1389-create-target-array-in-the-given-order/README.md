...
<ul>
	...
	<li>From left to right read <gistnote class="gistnote-highlight" highlightid="2bbe9bbc-5a00-4745-8e0e-d9825109289f" colornum="3" style="background-color: rgb(255, 251, 120);" id="2bbe9bbc-5a00-4745-8e0e-d9825109289f">nums[i] and index[i]</gistnote>, insert at index <code>index[i]</code>&nbsp;the value <code>nums[i]</code>&nbsp;in&nbsp;<em>target</em> array.</li>
